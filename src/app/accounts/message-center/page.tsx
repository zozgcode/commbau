...
export default function MessagePage() {
  return (
    <div className="">
      <div className="w-full text-black uppercase flex justify-between items-center p-4 bg-[#e6e6e6] relative">
        <Link href="/accounts" className="relative left-[20px]">
          <IoIosArrowBack className="text-2xl" />
        </Link>
        <span className="text-black text-lg font-semibold">Message Center</span>
        <svg
